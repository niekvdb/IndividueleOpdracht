<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Individuele_Opdracht.Login" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            <div class="form-signin">
                ...
                <asp:TextBox CssClass="form-control" ID="tb_rfid" runat="server" placeholder="E-mail" type="text" required="required" />
                ...
                <asp:Button CssClass="btn btn-lg btn-primary btn-block" ID="Submit" Text="Log in" runat="server" OnClick="Submit_Click" />
            </div>
            <div class="form-signin">
